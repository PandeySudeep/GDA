...
data = np.genfromtxt("https://raw.githubusercontent.com/DoneHome/machine-learning-python/master/algorithm/LogisticRegression/logistic_regression.csv", dtype=np.float64, delimiter=",")
